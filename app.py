...
def index():
    ...
    if request.method == "GET":
        gostei = 10 # pegue os gosteis
        gostei2 = 10 # pegue os gosteis2
        gostei3 = 10 # pegue os gosteis3

        return render_template('index.html', gosteis=gostei, gosteis2=gostei2, gosteis3=gostei3)
    else:
